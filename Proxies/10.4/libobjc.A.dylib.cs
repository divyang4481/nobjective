...
namespace NObjective.Proxies {
	...
	public struct NSDeallocatedObject : IEquatable<NSDeallocatedObject> {
		internal NObjective.RuntimeObject Handle;
		public static readonly RuntimeClass ClassHandle = libobjc_A_dylibCachedClasses.NSDeallocatedObject;
		public override int GetHashCode() {
			return Handle.GetHashCode();
		}
		public static implicit operator IntPtr( NSDeallocatedObject value ) {
			return value.Handle;
		}
		public static implicit operator NObjective.RuntimeObject( NSDeallocatedObject value ) {
			return value.Handle;
		}
		public override bool Equals( object value ) {
			if( !( value is NSDeallocatedObject ) ) return false; 
			return Handle == ( ( NSDeallocatedObject )value ).Handle;
		}
		public bool Equals( NSDeallocatedObject value ) {
			return Handle == value.Handle;
		}
		public static bool operator ==( NSDeallocatedObject value1, NSDeallocatedObject value2 ) {
			return value1.Handle == value2.Handle;
		}
		public static bool operator !=( NSDeallocatedObject value1, NSDeallocatedObject value2 ) {
			return value1.Handle != value2.Handle;
		}
		public NSDeallocatedObject( IntPtr value ) {
			this.Handle = new RuntimeObject( value );
		}
		public static NSDeallocatedObject alloc() {
			return new NSDeallocatedObject( ClassHandle.InvokeIntPtr( Selectors.alloc ) );
		}
		...
		unsafe public static NObjective.RuntimeObject __forward__( NObjective.Selector __forward, System.IntPtr unnamedParameter ) {
			RuntimeObject ___occuredException;
			var ___result = NativeMethods.__forward__( ClassHandle, CachedSelectors.__forward__, out ___occuredException, sizeof( NObjective.Selector ) + sizeof( System.IntPtr ), __forward, unnamedParameter );
			if( ___occuredException != RuntimeObject.Null ) throw RuntimeException.Create( ___occuredException ); 
			return new NObjective.RuntimeObject( ___result );
		}
		...
		private static class NativeMethods {
			...
			[DllImport(Runtime.InteropLibrary, EntryPoint = "objc_msgSend_eh2")]
			public static extern IntPtr __forward__( RuntimeClass ___class, Selector ___selector, out RuntimeObject ___occuredException, int ___stackSize, NObjective.Selector __forward, System.IntPtr unnamedParameter );
			[DllImport(Runtime.InteropLibrary, EntryPoint = "objc_msgSend_eh2")]
		...
		static internal class CachedSelectors {
			...
			public static readonly Selector __forward__ = "__forward::";
	...
	public struct NSResurrectedObject : IEquatable<NSResurrectedObject> {
		internal NObjective.RuntimeObject Handle;
		public static readonly RuntimeClass ClassHandle = libobjc_A_dylibCachedClasses.NSResurrectedObject;
		public override int GetHashCode() {
			return Handle.GetHashCode();
		}
		public static implicit operator IntPtr( NSResurrectedObject value ) {
			return value.Handle;
		}
		public static implicit operator NObjective.RuntimeObject( NSResurrectedObject value ) {
			return value.Handle;
		}
		public override bool Equals( object value ) {
			if( !( value is NSResurrectedObject ) ) return false; 
			return Handle == ( ( NSResurrectedObject )value ).Handle;
		}
		public bool Equals( NSResurrectedObject value ) {
			return Handle == value.Handle;
		}
		public static bool operator ==( NSResurrectedObject value1, NSResurrectedObject value2 ) {
			return value1.Handle == value2.Handle;
		}
		public static bool operator !=( NSResurrectedObject value1, NSResurrectedObject value2 ) {
			return value1.Handle != value2.Handle;
		}
		public NSResurrectedObject( IntPtr value ) {
			this.Handle = new RuntimeObject( value );
		}
		public static NSResurrectedObject alloc() {
			return new NSResurrectedObject( ClassHandle.InvokeIntPtr( Selectors.alloc ) );
		}
		public override string ToString() {
			return Handle.InvokeString( Selectors.description );
		}
	...
	public struct Protocol : IEquatable<Protocol> {
		...
		unsafe public static NObjective.RuntimeObject load() {
			RuntimeObject ___occuredException;
			var ___result = NativeMethods.load( ClassHandle, CachedSelectors.load, out ___occuredException, 0 );
			if( ___occuredException != RuntimeObject.Null ) throw RuntimeException.Create( ___occuredException ); 
			return new NObjective.RuntimeObject( ___result );
		}
		private static class NativeMethods {
			[DllImport(Runtime.InteropLibrary, EntryPoint = "objc_msgSend_eh2")]
			public static extern IntPtr load( RuntimeClass ___class, Selector ___selector, out RuntimeObject ___occuredException, int ___stackSize );
		}
		static internal class CachedSelectors {
	...
	static internal class libobjc_A_dylibCachedClasses {
		...
		public static readonly RuntimeClass NSDeallocatedObject = "NSDeallocatedObject";
		public static readonly RuntimeClass NSResurrectedObject = "NSResurrectedObject";
