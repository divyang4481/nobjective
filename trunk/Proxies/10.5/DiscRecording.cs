...
namespace NObjective.Proxies {
	...
	public struct DRPrepare : IEquatable<DRPrepare> {
		...
		public static implicit operator NSObject( DRPrepare value ) {
			return new NSObject( value.Handle );
		}
		...
		public override bool Equals( object value ) {
			var compareTo = value as DRPrepare?;
			return compareTo != null && Handle == compareTo.Value.Handle;
		}
	...
	public struct DRSession : IEquatable<DRSession> {
		...
		public static implicit operator NSObject( DRSession value ) {
			return new NSObject( value.Handle );
		}
		...
		public override bool Equals( object value ) {
			var compareTo = value as DRSession?;
			return compareTo != null && Handle == compareTo.Value.Handle;
		}
	...
	public struct DRSessionCDTextProducer : IEquatable<DRSessionCDTextProducer> {
		...
		public static implicit operator NSObject( DRSessionCDTextProducer value ) {
			return new NSObject( value.Handle );
		}
		...
		public override bool Equals( object value ) {
			var compareTo = value as DRSessionCDTextProducer?;
			return compareTo != null && Handle == compareTo.Value.Handle;
		}
	...
	public struct DRSessionProducerPlaceholder : IEquatable<DRSessionProducerPlaceholder> {
		...
		public static implicit operator NSObject( DRSessionProducerPlaceholder value ) {
			return new NSObject( value.Handle );
		}
		...
		public override bool Equals( object value ) {
			var compareTo = value as DRSessionProducerPlaceholder?;
			return compareTo != null && Handle == compareTo.Value.Handle;
		}
